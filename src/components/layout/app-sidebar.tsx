...
export const userNav = [
  ...
  { href: "/dashboard/services", label: "Layanan", icon: Boxes },
  { href: "/dashboard/food-vouchers", label: "Voucher Belanja", icon: UtensilsCrossed },
...
export const adminNav = [
  ...
  { href: "/admin/food-vouchers", label: "Voucher Belanja", icon: UtensilsCrossed },
...
export const sellerNav = [
  ...
  { href: "/seller/store", label: "Toko/Resto", icon: Store },
  { href: "/seller/products", label: "Produk PPOB", icon: Boxes },
  { href: "/seller/vouchers", label: "Voucher Belanja", icon: UtensilsCrossed },
  { href: "/seller/orders", label: "Pesanan Voucher", icon: ReceiptText },
    ...
    <aside className="sticky top-0 hidden h-screen w-72 shrink-0 overflow-y-auto border-r bg-white p-4 shadow-[12px_0_40px_rgba(15,23,42,0.04)] dark:bg-slate-950 lg:block">
      ...
      {!admin && !seller && (
        <div className="mt-6 rounded-xl border border-rose-100 bg-rose-50 p-4 text-rose-950">
          ...
          <p className="mt-1 text-xs leading-5 text-rose-800">Semua transaksi divalidasi server-side dengan mutasi saldo tercatat.</p>
        </div>
      )}
      {!admin && !seller && (
