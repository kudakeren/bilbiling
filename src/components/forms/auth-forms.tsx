...
export function LoginForm() {
  ...
  return (
    <Card className="glass-card mx-auto w-full max-w-md">
      <CardHeader>
        <BrandLogo />
        <CardTitle>Masuk ke bilbiling.com</CardTitle>
      </CardHeader>
      <CardContent>
        <form
          className="space-y-4"
    ...
    <Card className="glass-card mx-auto w-full max-w-lg">
      <CardHeader>
        ...
        <div className="mt-4 space-y-2">
          ...
          <CardTitle className="text-2xl font-black tracking-normal sm:text-3xl">Mulai Belanja Lebih Praktis</CardTitle>
          <p className="max-w-xl text-sm leading-6 text-muted-foreground">
            Satu akun untuk beli pulsa, paket data, tagihan PPOB, dan Voucher belanja favorit.
          </p>
        </div>
      </CardHeader>
      <CardContent>
    ...
    <Card className="glass-card mx-auto w-full max-w-2xl">
      <CardHeader>
        ...
        <div className="mt-4 space-y-2">
          ...
          <CardTitle className="text-2xl font-black tracking-normal sm:text-3xl">Daftar Jadi Reseller</CardTitle>
          <p className="max-w-xl text-sm leading-6 text-muted-foreground">
            Kelola produk PPOB dan Voucher Belanja dari dashboard seller setelah akun disetujui admin.
          </p>
        </div>
      </CardHeader>
      <CardContent>
        ...
        >
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="space-y-2"><Label>Nama toko/resto</Label><Input name="storeName" required /></div>
          ...
          <div className="space-y-2"><Label>Deskripsi toko</Label><Input name="description" placeholder="Contoh: Voucher Belanja, minuman, dan paket hemat" required /></div>
