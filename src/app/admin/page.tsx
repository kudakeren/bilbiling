      ...
      <div className="grid gap-6">
          ...
          <Card className="overflow-hidden border border-rose-100 bg-white text-slate-950 shadow-[0_24px_80px_rgba(16,185,129,.12)]">
            <CardContent className="relative p-6">
              ...
              <div className="relative">
                ...
                <h2 className="text-3xl font-black tracking-normal">Dashboard bilbiling.com</h2>
                <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-600">Pantau transaksi, refund, provider routing, promo, dan performa revenue harian dari satu console.</p>
                <div className="mt-6 grid gap-3 sm:grid-cols-4">
                  <AdminHeroMetric label="GMV dummy" value={formatRupiah(18450000)} />
                  <AdminHeroMetric label="Success rate" value="99.1%" />
                  <AdminHeroMetric label="Provider" value="4 aktif" />
          ...
          <Card className="overflow-hidden border bg-white shadow-sm dark:bg-slate-950">
            <CardContent className="relative p-5">
              ...
              <div className="space-y-4">
                ...
                <AdminQueue icon={<ShieldCheck className="h-5 w-5" />} title="Audit saldo" text="Balance mutation tercatat real-time" tone="text-rose-600 bg-rose-500/10" />
              </div>
            </CardContent>
          </Card>
        </div>
        ...
        <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          {[
            ...
            ["/admin/products", "Manage Products", "Harga jual, fee, provider, kategori", Boxes, "bg-rose-500/10 text-rose-600"],
            ...
            <CardContent className="relative p-6">
              ...
              <div>
                ...
                <div className="mt-5 grid gap-3 sm:grid-cols-2">
                  {["NusaPay Aggregator", "PLN Gateway", "Wallet Switcher", "Game Voucher Hub"].map((name, index) => (
          ...
          <Card className="border bg-white shadow-sm dark:bg-slate-950">
            <CardContent className="p-6">
              ...
              <div className="mt-4 space-y-3 text-sm">
                {["Database migration siap", "Seed data demo tersedia", "Role admin aktif", "Invoice dan mutasi saldo tercatat"].map((item) => (
